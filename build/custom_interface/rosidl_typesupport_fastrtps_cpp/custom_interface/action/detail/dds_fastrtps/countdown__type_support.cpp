...
#include "custom_interface/action/detail/countdown__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_interface::action::Countdown_Goal & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_interface::action::Countdown_Goal & ros_message)
{
  // Member: start_from
  cdr >> ros_message.start_from;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_interface::action::Countdown_Goal;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_interface::action::Countdown_Goal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_interface::action::Countdown_Goal *>(
    untyped_ros_message);
...
{
  return &custom_interface::action::typesupport_fastrtps_cpp::_Countdown_Goal__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interface, action, Countdown_Goal)() {
  return &custom_interface::action::typesupport_fastrtps_cpp::_Countdown_Goal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_custom_interface
cdr_serialize(
  const custom_interface::action::Countdown_Result & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: result_text
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_interface::action::Countdown_Result & ros_message)
{
  // Member: result_text
  cdr >> ros_message.result_text;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = custom_interface::action::Countdown_Result;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_interface::action::Countdown_Result *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<custom_interface::action::Countdown_Result *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &custom_interface::action::typesupport_fastrtps_cpp::_Countdown_Result__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interface, action, Countdown_Result)() {
  return &custom_interface::action::typesupport_fastrtps_cpp::_Countdown_Result__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_custom_interface
cdr_serialize(
  const custom_interface::action::Countdown_Feedback & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: current
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_interface::action::Countdown_Feedback & ros_message)
{
  // Member: current
  cdr >> ros_message.current;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = custom_interface::action::Countdown_Feedback;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_interface::action::Countdown_Feedback *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<custom_interface::action::Countdown_Feedback *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &custom_interface::action::typesupport_fastrtps_cpp::_Countdown_Feedback__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interface, action, Countdown_Feedback)() {
  return &custom_interface::action::typesupport_fastrtps_cpp::_Countdown_Feedback__handle;
}
...
// functions for custom_interface::action::Countdown_Goal already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_custom_interface
cdr_serialize(
  const custom_interface::action::Countdown_SendGoal_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_interface::action::Countdown_SendGoal_Request & ros_message)
{
  // Member: goal_id
  ...
  size_t current_alignment)
{
  ...
  // Member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        custom_interface::action::typesupport_fastrtps_cpp::max_serialized_size_Countdown_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = custom_interface::action::Countdown_SendGoal_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_interface::action::Countdown_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<custom_interface::action::Countdown_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &custom_interface::action::typesupport_fastrtps_cpp::_Countdown_SendGoal_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interface, action, Countdown_SendGoal_Request)() {
  return &custom_interface::action::typesupport_fastrtps_cpp::_Countdown_SendGoal_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_custom_interface
cdr_serialize(
  const custom_interface::action::Countdown_SendGoal_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: accepted
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_interface::action::Countdown_SendGoal_Response & ros_message)
{
  // Member: accepted
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = custom_interface::action::Countdown_SendGoal_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_interface::action::Countdown_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<custom_interface::action::Countdown_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &custom_interface::action::typesupport_fastrtps_cpp::_Countdown_SendGoal_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interface, action, Countdown_SendGoal_Response)() {
  return &custom_interface::action::typesupport_fastrtps_cpp::_Countdown_SendGoal_Response__handle;
}
...
{
  return &custom_interface::action::typesupport_fastrtps_cpp::_Countdown_SendGoal__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interface, action, Countdown_SendGoal)() {
  return &custom_interface::action::typesupport_fastrtps_cpp::_Countdown_SendGoal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_custom_interface
cdr_serialize(
  const custom_interface::action::Countdown_GetResult_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_interface::action::Countdown_GetResult_Request & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = custom_interface::action::Countdown_GetResult_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_interface::action::Countdown_GetResult_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<custom_interface::action::Countdown_GetResult_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &custom_interface::action::typesupport_fastrtps_cpp::_Countdown_GetResult_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interface, action, Countdown_GetResult_Request)() {
  return &custom_interface::action::typesupport_fastrtps_cpp::_Countdown_GetResult_Request__handle;
}
...
// forward declaration of message dependencies and their conversion functions
// functions for custom_interface::action::Countdown_Result already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_custom_interface
cdr_serialize(
  const custom_interface::action::Countdown_GetResult_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: status
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_interface::action::Countdown_GetResult_Response & ros_message)
{
  // Member: status
  cdr >> ros_message.status;
  ...
  size_t current_alignment)
{
  ...
  // Member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        custom_interface::action::typesupport_fastrtps_cpp::max_serialized_size_Countdown_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = custom_interface::action::Countdown_GetResult_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_interface::action::Countdown_GetResult_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<custom_interface::action::Countdown_GetResult_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &custom_interface::action::typesupport_fastrtps_cpp::_Countdown_GetResult_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interface, action, Countdown_GetResult_Response)() {
  return &custom_interface::action::typesupport_fastrtps_cpp::_Countdown_GetResult_Response__handle;
}
...
{
  return &custom_interface::action::typesupport_fastrtps_cpp::_Countdown_GetResult__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interface, action, Countdown_GetResult)() {
  return &custom_interface::action::typesupport_fastrtps_cpp::_Countdown_GetResult__handle;
}
...
// functions for custom_interface::action::Countdown_Feedback already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_custom_interface
cdr_serialize(
  const custom_interface::action::Countdown_FeedbackMessage & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_interface::action::Countdown_FeedbackMessage & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  // Member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        custom_interface::action::typesupport_fastrtps_cpp::max_serialized_size_Countdown_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = custom_interface::action::Countdown_FeedbackMessage;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_interface::action::Countdown_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<custom_interface::action::Countdown_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &custom_interface::action::typesupport_fastrtps_cpp::_Countdown_FeedbackMessage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interface, action, Countdown_FeedbackMessage)() {
  return &custom_interface::action::typesupport_fastrtps_cpp::_Countdown_FeedbackMessage__handle;
}
