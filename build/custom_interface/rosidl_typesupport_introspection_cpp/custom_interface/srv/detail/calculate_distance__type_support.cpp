...
static const ::rosidl_typesupport_introspection_cpp::MessageMember CalculateDistance_Request_message_member_array[2] = {
  {
    ...
    offsetof(custom_interface::srv::CalculateDistance_Request, start_point),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interface::srv::CalculateDistance_Request, end_point),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
