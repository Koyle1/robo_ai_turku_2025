...
class Init_CalculateDistance_Request_end_point
{
public:
  explicit Init_CalculateDistance_Request_end_point(::custom_interface::srv::CalculateDistance_Request & msg)
  : msg_(msg)
  {}
  ::custom_interface::srv::CalculateDistance_Request end_point(::custom_interface::srv::CalculateDistance_Request::_end_point_type arg)
  {
...
class Init_CalculateDistance_Request_start_point
{
public:
  Init_CalculateDistance_Request_start_point()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_CalculateDistance_Request_end_point start_point(::custom_interface::srv::CalculateDistance_Request::_start_point_type arg)
  {
    msg_.start_point = std::move(arg);
    return Init_CalculateDistance_Request_end_point(msg_);
  }
...
{
  return custom_interface::srv::builder::Init_CalculateDistance_Request_start_point();
}
