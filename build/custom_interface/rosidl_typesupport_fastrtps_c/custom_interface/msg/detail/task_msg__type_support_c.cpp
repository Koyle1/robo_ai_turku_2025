...
#include "custom_interface/msg/detail/task_msg__rosidl_typesupport_fastrtps_c.h"
...
using _TaskMsg__ros_msg_type = custom_interface__msg__TaskMsg;
...
size_t get_serialized_size_custom_interface__msg__TaskMsg(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _TaskMsg__ros_msg_type * ros_message = static_cast<const _TaskMsg__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _TaskMsg__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_interface__msg__TaskMsg(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interface
size_t max_serialized_size_custom_interface__msg__TaskMsg(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_interface__msg__TaskMsg;
    is_plain =
      (
...
static size_t _TaskMsg__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_interface__msg__TaskMsg(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interface, msg, TaskMsg)() {
