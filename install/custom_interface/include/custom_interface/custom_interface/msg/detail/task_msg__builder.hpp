...
{
public:
  explicit Init_TaskMsg_name(::custom_interface::msg::TaskMsg & msg)
  : msg_(msg)
  {}
...
class Init_TaskMsg_header
{
public:
  Init_TaskMsg_header()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_TaskMsg_name header(::custom_interface::msg::TaskMsg::_header_type arg)
  {
    msg_.header = std::move(arg);
    return Init_TaskMsg_name(msg_);
  }
...
{
  return custom_interface::msg::builder::Init_TaskMsg_header();
}
