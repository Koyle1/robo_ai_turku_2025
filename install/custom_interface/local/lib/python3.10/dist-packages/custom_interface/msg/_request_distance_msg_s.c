...
bool custom_interface__msg__request_distance_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_interface.msg._request_distance_msg.RequestDistanceMsg", full_classname_dest, 61) == 0);
  }
  custom_interface__msg__RequestDistanceMsg * ros_message = _ros_message;
  {  // start_point
...
{
  /* NOTE(esteve): Call constructor of RequestDistanceMsg */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_interface.msg._request_distance_msg");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RequestDistanceMsg");
