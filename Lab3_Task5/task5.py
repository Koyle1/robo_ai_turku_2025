...
def main():
    ...
    cv2.imwrite("box_blur_3x3.jpg", blurred_3x3)
    cv2.imwrite("box_blur_5x5.jpg", blurred_5x5)
    cv2.imwrite("box_blur_7x7.jpg", blurred_7x7)
    cv2.imwrite("gaussian_blur_5x5.jpg", gaussian_blur)
